...
return [
    ...
    'form_elements' => [
        ...
        'factories' => [
            ...
            Form\ResourceBatchUpdateForm::class => Service\Form\ResourceBatchUpdateFormFactory::class,
            Form\UserForm::class => Service\Form\UserFormFactory::class,
            Form\SettingForm::class => Service\Form\SettingFormFactory::class,
            Form\ModuleStateChangeForm::class => Service\Form\ModuleStateChangeFormFactory::class,
            Form\SiteForm::class => Service\Form\SiteFormFactory::class,
            Form\SiteSettingsForm::class => Service\Form\SiteSettingsFormFactory::class,
            Form\UserBatchUpdateForm::class => Service\Form\UserBatchUpdateFormFactory::class,
            Form\Element\ResourceSelect::class => Service\Form\Element\ResourceSelectFactory::class,
            Form\Element\ResourceClassSelect::class => Service\Form\Element\ResourceClassSelectFactory::class,
            ...
            Form\Element\LocaleSelect::class => Service\Form\Element\LocaleSelectFactory::class,
            Form\Element\RoleSelect::class => Service\Form\Element\RoleSelectFactory::class,
            Form\Element\Recaptcha::class => Service\Form\Element\RecaptchaFactory::class,
            Form\Element\HtmlTextarea::class => Service\Form\Element\HtmlTextareaFactory::class,
            Form\Element\Ckeditor::class => Service\Form\Element\CkeditorFactory::class,
            Form\Element\CkeditorInline::class => Service\Form\Element\CkeditorInlineFactory::class,
        ],
    ],
    'data_types' => [
        'invokables' => [
